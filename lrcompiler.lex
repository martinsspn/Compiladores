...
"int"                     col += yyleng; yylval.type = 1; return KW_INT;
"bool"                    col += yyleng; return KW_BOOL;
"float"                   col += yyleng; yylval.type = 2; return KW_FLOAT;
"char"                    col += yyleng; yylval.type = 3; return KW_CHAR;
...
"|"                       col += yyleng; return '|';
"?"                       col += yyleng; return '?';
{int}                     col += yyleng; yylval.type = 1; yylval.itype = (int) atoi(yytext); return INT;
{floatpoint}              col += yyleng; yylval.type = 2; yylval.dtype = (double) atol(yytext); return FLOAT;
{charobj}                 col += yyleng; yylval.type = 3; yylval.ctype = (char) yytext[1]; return CHAR;
{identifier}              col += yyleng; yylval.type = 4; yylval.string = (char *) strdup(yytext); return IDENTIFIER;
